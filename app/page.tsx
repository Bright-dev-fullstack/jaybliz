...
export default function Home() {
  const studioServices = [
    {
      name: "Hair Cut",
      desc: "Precision cut, razor lineup, styling finish",
      price: "₦5,000",
    },
    {
      name: "Washing and Haircut",
      desc: "Deep cleansing wash, cut, hot towel finish",
      price: "₦7,000",
    },
    {
      name: "Hair Cut (Home Service)",
      desc: "Mobile grooming at your private residence or office",
      price: "₦10,000+",
    },
    {
      name: "Hair Tint",
      desc: "Custom color transformation & conditioning treatment",
      price: "₦15,000+",
    },
    {
      name: "Braids",
      desc: "Custom protective styles & clean parting",
      price: "₦10,000+",
    },
  ];
  ...
  const spaServices = [
    ...
    },
    {
      ...
      desc: "Advanced exfoliation & dead skin cell removal",
      price: "₦20,000",
    },
    {
      name: "Regular Pedicure",
      desc: "Essential foot soak, nail shaping & soothing massage",
      price: "₦12,000",
    },
    {
      name: "Deluxe Pedicure",
      desc: "Premium scrub, hydrating mask & extended massage",
      price: "₦15,000",
    },
    {
      name: "Manicure",
      desc: "Hand scrub, nail shaping & cuticle care",
      price: "₦7,000",
    },
    {
      name: "Tattoos",
      desc: "Custom ink art using sterile, professional equipment",
      price: "₦20,000+",
    },
  ];
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p className="max-w-xl text-sm md:text-lg text-stone-400 mb-12 font-light leading-relaxed px-2">
            Where precision barbering meets luxury spa therapy. Experience world-class cuts, body ink art, or summon our home service specialists to your private residence.
          </p>
          ...
          <div className="flex items-center gap-4 text-center lg:text-left flex-col sm:flex-row">
            ...
            <div>
              <span className="text-xs font-black tracking-widest uppercase block mb-0.5 text-stone-950">
                Home Service & Mobile Haircuts
              </span>
              <p className="text-xs font-medium max-w-xl text-stone-900/90 leading-relaxed">
                Can&apos;t clear your schedule to visit our lounge? Select our Home Service haircut option starting at ₦10,000 to bring our master tailored setup directly to your doorstep.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 lg:max-w-lg">
            ...
            <p className="text-stone-400 leading-relaxed font-light">
              At Jaybliz Cut, we believe that grooming is more than a routine—it’s a physical ritual. Our master barbers bring pristine technical expertise in classical tailoring and contemporary contours, ensuring every cut, tint, and style is a masterpiece.
            </p>
            <p className="text-stone-400 leading-relaxed font-light">
              Step past the active studio chairs into our isolated spa sanctuary, built specifically for physical decompression. From custom facial treatments and dermaplaning to pedicures and custom ink art, realigned luxury awaits.
            </p>
          </div>
      ...
      <section className="relative z-10 bg-stone-950 py-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
            ...
            {/* Spa & Wellness Menu mapping */}
            <div className="bg-stone-900/20 p-6 rounded-none border border-stone-900/50 backdrop-blur-sm">
              <h3 className="text-lg font-medium tracking-[0.2em] uppercase text-stone-200 border-b border-stone-800/80 pb-4 mb-8 flex justify-between items-center">
                <span>Spa & Body Care</span>
                <span className="text-[10px] text-amber-400/60 font-sans tracking-widest">WELLNESS & INK</span>
              </h3>
              <div className="space-y-8">
          ...
          <div className="text-center mt-16">
            <Link href="/book" className="inline-block border-b border-amber-400/40 text-amber-400 hover:text-amber-300 hover:border-amber-300 pb-1 text-sm tracking-widest uppercase transition duration-200 font-medium">
